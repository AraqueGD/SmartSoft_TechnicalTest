...
var ProductsController = /** @class */ (function () {
    function ProductsController() {
        this.productsRepository = typeorm_1.getRepository(Products_1.Products);
    }
    ProductsController.prototype.getProducts = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.find({ relations: ["category"] })];
    ...
    ProductsController.prototype.updateProducts = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var products;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.findOne(req.params.id)];
                    case 1:
                        products = _a.sent();
                        if (products) {
                            this.productsRepository.merge(products, req.body);
                            return [2 /*return*/, this.productsRepository.save(products)];
                        }
                        return [2 /*return*/, res.status(404).json({ message: "Not Product Found" })];
                }
            });
        });
    };
    ProductsController.prototype.deleteProduct = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.productsRepository.delete(req.params.id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
