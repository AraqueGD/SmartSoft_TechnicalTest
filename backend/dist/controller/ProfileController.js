...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.updateProfile = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var updateProfile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne(req.params.id, { relations: ["profile"] })];
                    case 1:
                        updateProfile = _a.sent();
                        if (!updateProfile) return [3 /*break*/, 3];
                        this.userRepository.merge(updateProfile, req.body);
                        return [4 /*yield*/, this.userRepository.save(updateProfile)];
                    case 2: return [2 /*return*/, _a.sent()];
